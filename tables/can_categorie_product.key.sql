...
ALTER TABLE can_categorie_product ADD INDEX idx_categorie_product_fk_categorie (fk_categorie);
ALTER TABLE can_categorie_product ADD INDEX idx_categorie_product_fk_product (fk_product);
