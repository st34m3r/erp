...
alter table can_tmp_caisse modify fk_tva int(11) NOT NULL;

drop table can_facture_stats;
drop table can_stock_valorisation;
drop table can_entrepot_valorisation;
drop table can_groupesociete_remise;
drop table can_groupesociete;

update can_actioncomm set datep = datec where datep is null and datec is not null;

-- Create new table for import module
create table can_import_model
(
...
-- 2 forgotten tables
create table can_product_cnv_livre
(
...
create table can_product_cnv_livre_contrat
(
  rowid              integer AUTO_INCREMENT PRIMARY KEY,
...
update can_bank_url set type='banktransfert' where type='?' and label='(banktransfert)';

ALTER TABLE can_import_model ADD UNIQUE INDEX uk_import_model (label,type);

delete from can_const where name = 'FACTURE_ENABLE_RECUR';

alter table can_facturedet_rec add column  product_type		  integer    DEFAULT 0 after fk_product;

alter table can_c_chargesociales change actioncompta code varchar(12) NOT NULL;
alter table can_c_chargesociales add column  fk_pays  integer    DEFAULT 1 NOT NULL;

-- Usage of can_menu_const and can_menu_constraint is too complicated
-- so we made first change to remove it
alter table can_menu_const drop foreign key fk_menu_const_fk_menu;
update can_menu_constraint set action = '$conf->societe->enabled' where action = '$conf->commercial->enabled';

ALTER TABLE can_adherent ADD UNIQUE INDEX uk_adherent_fk_soc (fk_soc);

alter table can_facture add column  tms timestamp after date_valid;
alter table can_facture_fourn add column  tms timestamp after datef;
alter table can_facture_fourn add column  fk_facture_source   integer after fk_user_valid;
  
update can_facture set tms = datec where tms <= 0;
update can_facture_fourn set tms = datec where tms <= 0;


-- Clean no more required parameters
delete from can_const where name = 'MAIN_MODULE_COMMERCIAL';
delete from can_const where name like 'MAIN_MODULE_%_DIR_OUTPUT';
delete from can_const where name like 'MAIN_MODULE_%_DIR_TEMP';
delete from can_const where name like 'PRODUIT_CONFIRM_DELETE_LINE';
delete from can_const where name = 'MAIN_MODULE_SYSLOG' and entity = 2;
delete from can_const where name = 'SYSLOG_FILE' and entity = 2;
delete from can_const where name = 'SYSLOG_LEVEL' and entity = 2;

alter table can_societe add column import_key varchar(14);

 
-- V4.1 delete from can_paiementfourn where rowid not in (select fk_paiementfourn from can_paiementfourn_facturefourn);
-- V4.1 delete from can_paiementfourn_facturefourn where fk_facturefourn not in (select rowid from can_facture_fourn);


 
-- Multi company
ALTER TABLE can_rights_def ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER module;
ALTER TABLE can_events ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER type;
ALTER TABLE can_boxes_def ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER file;
ALTER TABLE can_user_param ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER fk_user;
ALTER TABLE can_societe ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER nom;
ALTER TABLE can_socpeople ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER fk_soc;
ALTER TABLE can_product ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_entrepot ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER label;
ALTER TABLE can_chargesociales ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER libelle;
ALTER TABLE can_tva ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER label;
ALTER TABLE can_bank_account ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER label;
ALTER TABLE can_document_model ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER nom;
ALTER TABLE can_menu ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER menu_handler;
ALTER TABLE can_ecm_directories ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER label;
ALTER TABLE can_mailing ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER titre;
ALTER TABLE can_categorie ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER label;
ALTER TABLE can_propal ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_commande ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_commande_fournisseur ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_product_fournisseur ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref_fourn;
ALTER TABLE can_facture ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER facnumber;
ALTER TABLE can_expedition ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_facture_fourn ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER facnumber;
ALTER TABLE can_livraison ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_fichinter ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_contrat ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_c_barcode_type ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER code;
ALTER TABLE can_dolibarr_modules ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER numero;
ALTER TABLE can_bank_categ ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER label;
ALTER TABLE can_bordereau_cheque ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER number;
ALTER TABLE can_prelevement_bons ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_projet ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER ref;
ALTER TABLE can_adherent ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER rowid;
ALTER TABLE can_adherent_type ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER rowid;
ALTER TABLE can_adherent_options_label ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER name;
ALTER TABLE can_facture_rec ADD COLUMN entity integer DEFAULT 1 NOT NULL AFTER fk_soc;

ALTER TABLE can_rights_def DROP PRIMARY KEY;
ALTER TABLE can_dolibarr_modules DROP PRIMARY KEY;

ALTER TABLE can_adherent_options_label DROP PRIMARY KEY;
ALTER TABLE can_adherent_options_label MODIFY COLUMN name varchar(64) NOT NULL;
ALTER TABLE can_adherent_options_label ADD COLUMN rowid integer AUTO_INCREMENT PRIMARY KEY FIRST;

ALTER TABLE can_user_param DROP INDEX fk_user;
ALTER TABLE can_societe DROP INDEX uk_societe_prefix_comm;
ALTER TABLE can_societe DROP INDEX uk_societe_code_client;
ALTER TABLE can_product DROP INDEX uk_product_ref;
ALTER TABLE can_entrepot DROP INDEX label;
ALTER TABLE can_bank_account DROP INDEX uk_bank_account_label;
ALTER TABLE can_document_model DROP INDEX uk_document_model;
ALTER TABLE can_menu DROP INDEX idx_menu_uk_menu;
ALTER TABLE can_categorie DROP INDEX uk_categorie_ref;
ALTER TABLE can_propal DROP INDEX ref;
ALTER TABLE can_commande DROP INDEX ref;
ALTER TABLE can_commande_fournisseur DROP INDEX uk_commande_fournisseur_ref;
ALTER TABLE can_product_fournisseur DROP INDEX fk_product;
ALTER TABLE can_product_fournisseur DROP INDEX fk_soc;
ALTER TABLE can_facture DROP INDEX idx_facture_uk_facnumber;
ALTER TABLE can_expedition DROP INDEX idx_expedition_uk_ref;
ALTER TABLE can_facture_fourn DROP INDEX uk_facture_fourn_ref;
ALTER TABLE can_livraison DROP INDEX idx_expedition_uk_ref;
ALTER TABLE can_livraison DROP INDEX idx_livraison_uk_ref;
ALTER TABLE can_fichinter DROP INDEX ref;
ALTER TABLE can_prelevement_bons DROP INDEX ref;
ALTER TABLE can_projet DROP INDEX ref;
ALTER TABLE can_boxes_def DROP INDEX uk_boxes_def;
ALTER TABLE can_adherent DROP INDEX uk_adherent_login;
ALTER TABLE can_adherent_type DROP INDEX uk_adherent_type_libelle;
ALTER TABLE can_facture_rec DROP INDEX idx_facture_rec_uk_titre;

ALTER TABLE can_rights_def ADD PRIMARY KEY pk_rights_def (id, entity);
ALTER TABLE can_dolibarr_modules ADD PRIMARY KEY pk_dolibarr_modules (numero, entity);

ALTER TABLE can_user_param ADD UNIQUE INDEX uk_user_param (fk_user,param,entity);
ALTER TABLE can_societe ADD UNIQUE INDEX uk_societe_prefix_comm (prefix_comm, entity);
ALTER TABLE can_societe ADD UNIQUE INDEX uk_societe_code_client (code_client, entity);
ALTER TABLE can_product ADD UNIQUE INDEX uk_product_ref (ref, entity);
ALTER TABLE can_entrepot ADD UNIQUE INDEX uk_entrepot_label (label, entity);
ALTER TABLE can_bank_account ADD UNIQUE INDEX uk_bank_account_label (label, entity);
ALTER TABLE can_document_model ADD UNIQUE INDEX uk_document_model (nom, type, entity);
ALTER TABLE can_menu ADD UNIQUE INDEX idx_menu_uk_menu (menu_handler, fk_menu, url, entity);
ALTER TABLE can_categorie ADD UNIQUE INDEX uk_categorie_ref (label, type, entity);
...
ALTER TABLE can_facture ADD UNIQUE INDEX idx_facture_uk_facnumber (facnumber, entity);
ALTER TABLE can_expedition ADD UNIQUE INDEX idx_expedition_uk_ref (ref, entity);
ALTER TABLE can_facture_fourn ADD UNIQUE INDEX uk_facture_fourn_ref (facnumber, fk_soc, entity);
ALTER TABLE can_livraison ADD UNIQUE INDEX idx_livraison_uk_ref (ref, entity);
ALTER TABLE can_fichinter ADD UNIQUE INDEX uk_fichinter_ref (ref, entity);
ALTER TABLE can_contrat ADD UNIQUE INDEX uk_contrat_ref (ref, entity);
ALTER TABLE can_bordereau_cheque ADD UNIQUE INDEX uk_bordereau_cheque (number, entity);
ALTER TABLE can_prelevement_bons ADD UNIQUE INDEX uk_prelevement_bons_ref (ref, entity);
ALTER TABLE can_projet ADD UNIQUE INDEX uk_projet_ref (ref, entity);
ALTER TABLE can_boxes_def ADD UNIQUE INDEX uk_boxes_def (file, entity);
ALTER TABLE can_adherent ADD UNIQUE INDEX uk_adherent_login (login, entity);
ALTER TABLE can_adherent_type ADD UNIQUE INDEX uk_adherent_type_libelle (libelle, entity);
ALTER TABLE can_adherent_options_label ADD UNIQUE INDEX uk_adherent_options_label_name (name, entity);
ALTER TABLE can_facture_rec ADD UNIQUE INDEX idx_facture_rec_uk_titre (titre, entity);

ALTER TABLE can_projet ADD INDEX idx_projet_fk_soc (fk_soc);
-- V4.1 update can_projet set fk_soc=null where fk_soc is not null and fk_soc not in (select rowid from can_societe);
ALTER TABLE can_projet ADD CONSTRAINT fk_projet_fk_soc FOREIGN KEY (fk_soc) REFERENCES can_societe (rowid);

ALTER TABLE can_facture_rec ADD CONSTRAINT fk_facture_rec_fk_soc FOREIGN KEY (fk_soc) REFERENCES can_societe (rowid);


UPDATE can_const SET entity=0 WHERE name='MAIN_MODULE_USER' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_POPUP_CALENDAR' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_MAIL_SMTP_SERVER' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_MAIL_SMTP_PORT' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_UPLOAD_DOC' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_FEATURES_LEVEL' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_SEARCHFORM_SOCIETE' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_SEARCHFORM_CONTACT' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_SEARCHFORM_PRODUITSERVICE' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_SEARCHFORM_ADHERENT' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_SIZE_LISTE_LIMIT' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='MAIN_SHOW_WORKBOARD' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='SOCIETE_NOLIST_COURRIER' AND entity=1;
UPDATE can_const SET entity=0 WHERE name='GENBARCODE_LOCATION' AND entity=1;

UPDATE can_const SET entity=0 WHERE name='MAIN_MODULE_SYSLOG';
UPDATE can_const SET entity=0 WHERE name='SYSLOG_FILE';
UPDATE can_const SET entity=0 WHERE name='SYSLOG_LEVEL';
...
ALTER TABLE can_events add column user_agent     varchar(128) NULL after ip;


alter table can_commande_fournisseur add column   ref_supplier        varchar(30) after entity;

alter table can_mailing add column bgcolor  varchar(8) after body;
alter table can_mailing add column bgimage  varchar(255) after bgcolor;
...
alter table can_facture_fourn_det add column ref               varchar(50) after fk_product;
alter table can_facture_fourn_det add column label             varchar(255) after ref;

alter table can_societe_rib modify column iban_prefix varchar(34);
alter table can_bank_account modify column iban_prefix varchar(34);


alter table can_projet add column datec date after fk_statut;

delete from can_action_def;
insert into can_action_def (rowid,code,titre,description,objet_type) values (1,'NOTIFY_VAL_FICHINTER','Validation fiche intervention','Executed when a intervention is validated','ficheinter');
insert into can_action_def (rowid,code,titre,description,objet_type) values (2,'NOTIFY_VAL_FAC','Validation facture client','Executed when a customer invoice is approved','facture');
insert into can_action_def (rowid,code,titre,description,objet_type) values (3,'NOTIFY_APP_ORDER_SUPPLIER','Approbation commande fournisseur','Executed when a supplier order is approved','order_supplier');
insert into can_action_def (rowid,code,titre,description,objet_type) values (4,'NOTIFY_REF_ORDER_SUPPLIER','Refus commande fournisseur','Executed when a supplier order is refused','order_supplier');


insert into can_c_tva(rowid,fk_pays,taux,recuperableonly,note,active) values ( 51, 5,  '19','0','VAT standard rate',1);
insert into can_c_tva(rowid,fk_pays,taux,recuperableonly,note,active) values ( 52, 5,   '7','0','VAT reduced rate', 1);
insert into can_c_tva(rowid,fk_pays,taux,recuperableonly,note,active) values ( 53, 5,   '0','0','VAT Rate 0', 1); 

-- Add rule to avoid duplicate use of discount
update can_facturedet set fk_remise_except = null where fk_remise_except = 0;
...
insert into can_c_tva(rowid,fk_pays,taux,recuperableonly,note,active) values (1521,152,  '0','0','VAT Rate 0',1);
insert into can_c_tva(rowid,fk_pays,taux,recuperableonly,note,active) values (1522,152,  '15','0','VAT Rate 15',1);
...
alter table can_const modify column name        varchar(255) NOT NULL;
alter table can_const modify column value       text NOT NULL;

-- SWEDEN (id 20)
insert into can_c_tva(rowid,fk_pays,taux,recuperableonly,note,active) values (201,20,  '25','0','VAT standard rate',1);
insert into can_c_tva(rowid,fk_pays,taux,recuperableonly,note,active) values (202,20,  '12','0','VAT reduced rate',1);
insert into can_c_tva(rowid,fk_pays,taux,recuperableonly,note,active) values (203,20,   '6','0','VAT super-reduced rate',1);
insert into can_c_tva(rowid,fk_pays,taux,recuperableonly,note,active) values (204,20,   '0','0','VAT Rate 0',  1);
...
alter table can_product_price modify price_level smallint NULL DEFAULT 1;
alter table can_commandedet modify special_code integer UNSIGNED DEFAULT 0;
alter table can_facturedet modify special_code integer UNSIGNED DEFAULT 0;
alter table can_propaldet modify special_code integer UNSIGNED DEFAULT 0;
alter table can_societe modify special_code integer NULL;
alter table can_c_forme_juridique modify code integer NOT NULL;

ALTER TABLE can_bank_class ADD UNIQUE INDEX idx_bank_class_lineid (lineid);
ALTER TABLE can_c_ecotaxe ADD UNIQUE INDEX uk_c_ecotaxe (code);
ALTER TABLE can_c_methode_commande_fournisseur ADD UNIQUE INDEX uk_c_methode_commande_fournisseur (code);

ALTER TABLE can_menu change user usertype      integer NOT NULL default '0';

-- Rename index
ALTER TABLE can_adherent_options MODIFY COLUMN optid integer;
ALTER TABLE can_adherent_options DROP PRIMARY KEY;
ALTER TABLE can_adherent_options DROP INDEX uk_adherent_options;
ALTER TABLE can_adherent_options DROP INDEX idx_adherent_options;
ALTER TABLE can_adherent_options DROP INDEX adhid;
ALTER TABLE can_adherent_options CHANGE optid rowid integer AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE can_adherent_options CHANGE adhid fk_member integer NOT NULL;
ALTER TABLE can_adherent_options ADD INDEX idx_adherent_options (fk_member);

ALTER TABLE can_adherent DROP INDEX idx_adherent_fk_soc;

ALTER TABLE can_propaldet ADD INDEX idx_propaldet_fk_propal (fk_propal);
-- V4.1 delete from can_propaldet where fk_propal not in (select rowid from can_propal);
ALTER TABLE can_propaldet ADD CONSTRAINT fk_propaldet_fk_propal FOREIGN KEY (fk_propal) REFERENCES can_propal (rowid);
